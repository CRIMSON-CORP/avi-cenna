  ...
  return (
    <html lang="en-NG" className={`${jakarta.variable} h-full antialiased`}>
      <body className="min-h-full">
        ...
        <a
          href="#main"
          className="focus-ring sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-60 focus:rounded-pill focus:bg-surface focus:px-5 focus:py-2.5 focus:text-sm focus:font-semibold focus:text-ink"
        >
          Skip to content
        </a>
        <Header />
