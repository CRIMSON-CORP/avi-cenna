...
export const galleries: Record<StageId, Gallery> = {
  early: {
    ...
    photos: [
      {
        src: `${dir}/early-years/IMG_1763.webp`,
        width: 2560,
        height: 1707,
      ...
      {
        src: `${dir}/early-years/IMG_2002.webp`,
        width: 2560,
        height: 1707,
      ...
      {
        src: `${dir}/early-years/IMG_3530.webp`,
        width: 2560,
        height: 1707,
  ...
  primary: {
    ...
    photos: [
      {
        src: `${dir}/primary/PRICE-GIVING-DAY-PRI-26-(37).webp`,
        width: 2048,
        height: 1360,
      ...
      {
        src: `${dir}/primary/PRICE-GIVING-DAY-PRI-26-(691).webp`,
        width: 2048,
        height: 1360,
      ...
      {
        src: `${dir}/primary/PRICE-GIVING-DAY-PRI-26-(39).webp`,
        width: 2560,
        height: 1707,
  ...
  secondary: {
    ...
    photos: [
      {
        src: `${dir}/secondary/PRICE-GIVING-DAY-SECONDARY-26-(373).webp`,
        width: 2560,
        height: 1707,
      ...
      {
        src: `${dir}/secondary/SEC-GRAD-26-182.webp`,
        width: 1536,
        height: 1020,
      ...
      {
        src: `${dir}/secondary/STEAM-26-291.webp`,
        width: 1536,
        height: 1020,
      ...
      {
        src: `${dir}/secondary/STEAM-26-408.webp`,
        width: 2560,
        height: 1700,
      ...
      {
        src: `${dir}/secondary/STEAM-26-774.webp`,
        width: 2560,
        height: 1700,
        alt: "The opening leg of a relay at Sports Day, four runners in house colours coming off the bend.",
        caption: "Sports Day",
